...
//    // it will take some time until it stops
...
//
//    parent ! Stop
//  // parent will be stopped
//    for (_ <- 1 to 10) parent ! "parent, are you still there?" // should not be received
  // will stop it's child as well
//    for (i <- 1 to 1000) child2 ! s"[$i] second kid, are you still alive?"
...
//    val abruptlyTerminatedActor = system.actorOf(Props[Child],"awaking-dead")
//    abruptlyTerminatedActor ! "you are about to be terminated"
//    abruptlyTerminatedActor ! Kill                             // will terminate the actor and throw exception
